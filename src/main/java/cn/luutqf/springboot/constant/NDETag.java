package cn.luutqf.springboot.constant;


/**
 * @Author ZhenYang
 * @Date Created in 2018/4/13 10:06
 * @Description
 */
public class NDETag {

    public static final int ComponentName = 1048592;
    public static final int ComponentIDNumber = 1048608;
    public static final int OtherComponentIDs = 1052672;
    public static final int OtherComponentNames = 1052673;
    public static final int ComponentManufacturingDate = 1048624;
    public static final int ComponentNotes = 1064960;
    public static final int ComponentManufacturingProcedure = 1310757;
    public static final int ComponentManufacturer = 1310760;
    public static final int MaterialName = 1057120;
    ...
    public static final int ShapeDesc = 1310807;  //形状概述
    ...
    public static final int StudyLength = 2097172; //检测长度
    public static final int DirectiveDate = 2097170;  //指令日期 自定义
    public static final int DirectiveID = 2097171;  //指令编号 自定义
    public static final int AccessionNumber = 524368;
    public static final int ComponentOwnerName = 524432;
    public static final int InspectingCompanyName = 528456;
    public static final int CertifyingInspectorName = 528480;
    public static final int StudyDescription = 528432;
    public static final int ReferenceSeriesSequence = 528976; //****

//    public static final int RefStudyInstanceUID = 2097165;
//    public static final int RefSeriesInstanceUID = 2097166;
    public static final int RefPurposeOfReferenceCodeSequence = 4235632;

    public static final int ExaminationNotes = 3293184;
    ...
    public static final int InspectorName = 528464;
    public static final int OperatorName = 528496;
    public static final int RelatedSeriesSequence = 528976; // */**

//    public static final int RefStudyInstanceUID = 000;
//    public static final int RefSeriesInstanceUID = 000;
//    public static final int RefPurposeOfReferenceCodeSequence = 000;
    ...
    public static final int CompanyName = 524416;
    public static final int CompanyAddress = 524417;
    public static final int StationName = 528400;
    public static final int DepartmentName = 528448;
    public static final int ManufacturersModelName = 528528;
    public static final int DeviceSerialNumber = 1576960;
    public static final int ScannerID = 1576968;
    ...
    public static final int RepairDirective = 1318921; //返修指令
    ...
    public static final int IndicationDescription = 1318936; //备注
    public static final int IndicationType = 1318938; //缺陷属性
    public static final int IndicationDisposition = 1318940; //建议及处置措施
    //自定义缺陷信息
    public static final int IndicationLocation = 1318941; //缺陷位置
    public static final int IndicationLength = 1318943; //缺陷长度
    public static final int IndicationDeepness = 1318944; //缺陷深度
    public static final int IndicationVersion = 1318945; //评定级别
    public static final int FirstLevelNum = 1318946; //一级张数
    public static final int SecondLevelNum = 1318947; //二级张数
    public static final int ThirdLevelNum = 1318948; //三级张数
    public static final int FourthLevelNum = 1318949; //四级张数
    public static final int IndicationStudyNum = 1318950; //检测张数
    public static final int IndicationPass = 1318951; //是否合格
    public static final int IndicationOverview = 1318952; //缺陷综述
    public static final int IndicationPhysicPropertySequence = 1318960;

    public static final int PropertyLabel = 1318962;
    public static final int PropertyValue = 4236042;
    public static final int PropertyUnitsCodeSequence = 4196586;




    public static final int CodeValue = 524544;
    public static final int CodeSchemeDesignator = 524546;
    public static final int CodingSchemeVersion = 524547;
    public static final int CodeMeaning = 524548;

    public static final int IndicationROIGeometricType = 7340067; // >>
//    public static final int IndicationROIValueType = 4235328;
    public static final int NumberOfROIContour = 7340065;
    public static final int IndicationROIContourData = 7340066;
...
//    public static final int IndicationROIGeometricType = 7340067;
    ...
    public static final int NumberOfROIContourPoints = 7340065;
//    public static final int IndicationROIContourData = 7340066;
    ...
    public static final int CoordinateSystemRotationAndScaleMatrix = 1319466;
    public static final int CoordinateSystemTranslationMatrix = 1319468;
